...
class Window:
    ...
    _WINDOW_CLASS = "Window" #переменной присвоено значение строка
'''
пермениным присваивается значение
параметрам так же присваиваются значения

а чем это отличаются параметры, аргументи от переменных если им также присваиваются значения ?

'''

def __init__(  # в дущках функции пишутся параметры, иногда параметрам присваивается значение
     
        self,   
        id=None,   #переменной присвоено тип bool значение none
        title=None, #переменной присвоено тип bool  значение none
        position=(100, 100),  # переменна завернута в кортеж и присвоено числовое значение инт
        size=(640, 480), # переменна завернута в кортеж и присвоено числовое значение инт
        toolbar=None,  #переменной присвоено тип bool  значение none
        resizeable=True, #переменной присвоено тип bool  значение true
        closeable=True,  #переменной присвоено тип bool  значение true
        minimizable=True, #ппеременной присвоено тип bool  значение true
        factory=None,  # DEPRECATED !
        on_close=None, #переменной присвоено тип bool  значение none

        # везде где есть "none" "true" "foulse" это тип данных bool.  
        # но я еще не понимаю где и как используются этот тип
    ): 
        ...
        '''if = это финкция
         срабатывает в конкретном случае или параметрах и в противном случае срабатывает else'''
        ...
        self._impl = getattr(self.factory, self._WINDOW_CLASS)(  
            interface=self,
            title="Toga" if title is None else title, #переменные присвоено значение строка "Toga"
            position=position, #а это что значит? если это не строка, то что это за тип драних без кавычек.
            size=size,
        )
    ...
    def title(self, title):
        if not title:
            title = "Toga" #переменные присвоено значение строка "Toga"
